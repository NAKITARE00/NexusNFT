...
const ElectionCard = ({ electionName, voteToken, image, handleClick }) => {
    return (
        ...
        bg-[white] cursor-pointer" onClick={handleClick}>
            <img
                src={image}
                alt="vote"
            ...
            <div className="flex flex-col p-4">
                ...
                <div className="block">
                    <h3 className="font-epilogue font-semibold text-[16px] text-black text-left leading-[26px] truncate">{electionName}</h3>
                </div>
            </div>
        </div>
    )
